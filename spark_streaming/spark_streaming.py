...
# Retrieve values from environment variables (defined in Docker Compose)
KAFKA_BROKER = os.getenv("KAFKA_BROKER", "kafka:9092")
KAFKA_TOPIC = os.getenv("KAFKA_TOPIC", "dev_topic")
DELTA_LAKE_PATH = os.getenv("DELTA_LAKE_PATH", "s3a://my-bucket/delta-lake")
CHECKPOINT_DIR = os.getenv("CHECKPOINT_DIR", "s3a://my-bucket/delta-lake-checkpoint")
